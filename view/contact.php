        ...
        <section class="contact-info">
            <form class="info-form" action="" method="post" class="contact-form">
                ...
                <input id="firstname" class="<?php echo $contactInfo->getTextboxClass('firstname'); ?>" type="text"
                    placeholder="<?php echo __('contact_firstname'); ?>" name="firstname"
                    value="<?php echo $contactInfo->getFirstName(); ?>" oninput="setErrorEmptyInputbox('firstname')">

                <!-- Last name textbox -->
                <input id="lastname" class="<?php echo $contactInfo->getTextboxClass('lastname'); ?>" type="text"
                    placeholder="<?php echo __('contact_lastname'); ?>" name="lastname"
                    value="<?php echo $contactInfo->getLastName(); ?>" oninput="setErrorEmptyInputbox('lastname')">
                ...
                <input id="phonenumber" class="<?php echo $contactInfo->getTextboxClass('phonenumber'); ?>" type="text"
                    placeholder="<?php echo __('contact_phonenumber'); ?>" name="phonenumber"
                    value="<?php echo $contactInfo->getPhonenumber(); ?>" oninput="setErrorEmptyInputbox('phonenumber')">

                <!-- Subject textbox -->
                <input id="subject" class="<?php echo $contactInfo->getTextboxClass('subject'); ?>" type="text"
                    placeholder="<?php echo __('contact_subject'); ?>" name="subject"
                    value="<?php echo $contactInfo->getSubject(); ?>" oninput="setErrorEmptyInputbox('subject')">

                <!-- Message textbox -->
                <textarea id="message" class="<?php echo $contactInfo->getTextboxClass('message'); ?>"
                    placeholder="<?php echo __('contact_message'); ?>" name="message"
                    oninput="setErrorEmptyInputbox('message')"><?php echo $contactInfo->getMessage(); ?></textarea>
